...
class WrkEnviosSearch extends WrkEnvios
{
    ...
    public function searchExportarEnvios($params)
    {
        ...
        $query->FilterWhere(['<>', 'txt_pais','MX'])->andFilterWhere(['is not','id_cliente',null]);
    ...
    public function searchImportarEnvios($params)
    {
        $query = WrkEnvios::find()->joinWith('origen')->where(['is not', 'txt_folio', null])->andWhere(['is not', 'txt_tracking_number', null]);
